    ...
    <div>
      ...
      <div className="p-5">
        ...
        {dynamicFilterOptions.programTypes?.length > 0 && (
          ...
          >
            <CheckboxFilter
              items={dynamicFilterOptions.programTypes}
              ...
              onFilterChange={onCheckboxFilter as any}
            />
          </FilterSection>
        )}

        {dynamicFilterOptions.degreeTypes?.length > 0 && (
          <FilterSection
            title="Degree Type"
            isExpanded={expandedFilters.degree_type}
            onToggle={() => onToggleFilter("degree_type")}
          >
            <CheckboxFilter
              items={dynamicFilterOptions.degreeTypes}
              filterType="degree_type"
              selectedItems={filters.degree_type}
              searchTerm={filterSearchTerms.degree_type}
              onSearchChange={(value) =>
                onFilterSearchChange("degree_type", value)
              }
              onFilterChange={onCheckboxFilter as any}
            />
          </FilterSection>
