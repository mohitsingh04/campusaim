...
const title = "Top Universities in India";
const keywords = [
...
const description =
  "Discover top universities in India. Compare rankings, courses, fees, placements & admission details to choose the right university for your future.";
const canonical = "/coachings";
const featuredImage = [
  {
...
export default function YogaInsitutesPage() {
  return (
    <Suspense fallback={<InsitutesLoader />}>
      <InstitutesPage pageCat="university" />
    </Suspense>
  );
}
