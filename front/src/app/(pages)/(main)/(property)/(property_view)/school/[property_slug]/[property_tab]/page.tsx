...
export async function generateMetadata({
  ...
  const baseMetaDescription =
    ...
    `Explore ${property?.property_name} ${location?.property_city} ${property_tab?.replaceAll("-", " ")} including courses, fees, admission & ranking. Top ranking school with top placements & facilities.`;
  ...
  const canonical = `${BASE_URL}/school/${property?.property_slug}/${property_tab}`;
