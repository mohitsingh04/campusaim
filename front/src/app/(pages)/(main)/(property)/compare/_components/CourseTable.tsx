...
export default function CourseTable({
  ...
  const courseFields = [
    { key: "Course Name", label: "Course Name", icon: BookIcon },
    { key: "Short Name", label: "Short Name", icon: PenIcon },
    { key: "Duration", label: "Duration", icon: ClockIcon },
    { key: "Course Type", label: "Course Type", icon: TargetIcon },
    { key: "Degree Type", label: "Degree Type", icon: TargetIcon },
    { key: "Program Type", label: "Program Type", icon: TargetIcon },
  ];
                ...
                <div className="sticky top-16 bg-(--primary-bg) shadow-md border-b border-(--border)">
                  <div className="px-4 py-3 bg-(--primary-bg) border-b border-(--border)">
                    <label className="text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-2 text-(--text-color-emphasis)">
                      <GraduationCapIcon size={14} className="text-(--main)" />
                      Select Course:
                    </label>
