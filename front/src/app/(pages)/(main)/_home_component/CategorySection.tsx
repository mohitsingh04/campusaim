...
export default function CategorySection({
  ...
  const statsData = [
    ...
    },
    {
      ...
      href: "/yoga-institutes?category=university",
    },
    {
      description:
      ...
      href: "/yoga-institutes?category=college",
    },
    {
      description:
    ...
    <section className="relative bg-(--primary-bg)  py-10 px-4 sm:px-8  overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-6">
        <HeadingProps
          ...
          subtitle="Trusted institutes. Top-rated studios. Certified education. Filter by your goal, whether it's a Teacher Training or a local class."
        />
...
function Card({ item, idx, hoverIndex, setHoverIndex }: any) {
  ...
  return (
    ...
    >
      ...
      <p className="text-base sm:text-sm text-(--text-color)">{item.description}</p>
    </Link>
  );
}
