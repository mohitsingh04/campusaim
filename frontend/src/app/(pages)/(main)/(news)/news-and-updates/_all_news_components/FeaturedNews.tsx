...
const FeaturedNews = ({ update }: { update: NewsProps }) => {
  return (
        ...
        style={{
          backgroundImage: `url(${
            update?.featured_image?.[0]
              ? `${process.env.NEXT_PUBLIC_MEDIA_URL}/news-and-updates/${update.featured_image[0]}`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-purple-100 text-lg mb-2 leading-relaxed">
              {stripHtmlAndLimit(update?.content, 240)}
            </p>
            ...
            <div className="flex items-center space-x-6 text-purple-200 mb-4">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm">
                  {formatTo12Hour(update?.publish_date)}
                </span>
              </div>
            </div>
