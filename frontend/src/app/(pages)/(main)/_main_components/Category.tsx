...
const categories: CategoryItem[] = [
	...
	},
	{
		...
		title: "Universities",
		link: "university",
		description: "Explore university-level degree & diploma programs.",
	...
	return (
		<section className="py-20 px-4 sm:px-10 md:px-20">
			...
			<motion.p
				...
				viewport={{ once: true }}
			>
				Explore properties options tailored to your goals—from online classes to
				top institutions.
			</motion.p>
				...
				{categories.map((cat, index) => {
					...
					return (
						...
						>
							...
							<Link
								href={`/colleges?academic_type=${cat?.link}`}
