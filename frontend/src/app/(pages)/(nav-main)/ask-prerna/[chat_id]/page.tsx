...
import { getProfile, getToken } from "@/contexts/getAssets";
...
export default function PrernaAiChat() {
  ...
  }, [chat_id, getPropertiesData, handlePropertySearchOnLoad, hasStarted]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      {isNotLogin && <NonLoginModal closeModal={() => setIsNotLogin(false)} />}
    </div>
  );
}
