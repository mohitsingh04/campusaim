...
import { Edit2, Eye, Plus, Trash, Trash2 } from "lucide-react";
        ...
        value: (row: ExamProps) => (
          <div className="flex gap-3">
            ...
            <div className="flex items-center">
              ...
              >
                {row?.exam_name}
                <p className="text-[var(--yp-muted)]">{row?.exam_short_name}</p>
              </Link>
            </div>
          </div>
        ),
              ...
              <>
                ...
                {matchPermissions(authUser?.permissions, "Update Exam") && (
                  <TableButton
                    ...
                    size="sm"
                    buttontype="link"
                    href={`/dashboard/exam/${row._id}/edit`}
                  />
                )}
