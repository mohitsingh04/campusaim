...
export default function CourseList({
	...
	const [propertyCourse, setPropertyCourse] = useState<any[]>([]);
	...
	}, [getPropertyCourses, getAllPropertyCourses]);
	...
	}, [propertyCourse, allCourses, getCategoryById]);
			...
			{isAdding ? (
				<div className="m-4 pb-4">
					<AddCourseForm
						...
						allPropertyCourse={allPropertyCourse}
						property={property}
