...
import WorkingHours from "./property_component/working_hours/WorkingHours";
import FAQs from "./property_component/faqs/Faqs";
import Certifications from "./property_component/certifications/Certifications";
...
import CouponManager from "./property_component/coupon/Coupon";
...
import Applications from "./property_component/application/Applications";
...
import Hiring from "./property_component/hiring/Hiring";
import CourseList from "./property_component/course/CourseList";
import RetreatList from "./property_component/retreat/RetreatList";
...
export function PropertyView() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: "Hiring",
      icon: ClipboardList,
      component: <Hiring property={property} />,
      online: false,
    },
    {
      id: "job-applications",
      ...
      icon: ClipboardList,
      component: <Applications property={property} />,
      online: false,
    },
    {
      id: "course",
    ...
    },
    {
      ...
      label: "Retreat",
      icon: ListChecks,
      component: <RetreatList property={property} />,
      online: false,
    },
    {
      id: "review",
    ...
    },
    {
      ...
      label: "Working Hours",
      icon: Clock,
      component: <WorkingHours property={property} />,
      online: isOnline,
    },
    {
      id: "teachers",
    ...
    },
    {
      ...
      icon: Award,
      component: <Certifications property={property} />,
      online: false,
    },
    {
      id: "coupons",
      label: "Coupons",
      icon: Tag,
      component: <CouponManager property={property} />,
      online: false,
    },
  ];
  if (loading) {
