...
export default function AddKeyOutCome({
  onClose,
  isOpen,
  getData,
  outcomes,
  ...
  // 🔍 Filter outcomes dynamically as user types
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const matches = outcomes.filter((item) =>
      item?.key_outcome?.toLowerCase()?.includes(query)
    );
    setFiltered(matches);
